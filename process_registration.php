...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $from_email = "info@rengatreffen.it";

    $headers = "From: Renga Treffen <" . $from_email . ">\r\n";
    $headers .= "Reply-To: info@rengatreffen.it\r\n";
    $headers .= "X-Mailer: PHP/" . phpversion();

    $message .= "--- \n";
    $message .= "Renga Treffen 2026, Per qualsiasi domanda puoi rispondere direttamente a questa email.";
